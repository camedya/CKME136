...
As none of the variances are equal, non-parametric comparisons will be used on the Good and Poor data sets.
...
As the p-value is greated than 0 .05, the null hypothesis holds and the actual values for the data are concluded to be statistically equal to the predicted values from the model. Therefore, the model is a good fit.
